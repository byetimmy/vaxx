...
const AWS_REGION = process.env.AWS_REGION || 'us-east-1';
const AWS_SECRET = process.env.AWS_SECRET || '';
const BASE_MATCH = process.env.BASE_MATCH || 'Available Appointments';
const BASE_SITE = process.env.BASE_SITE || 'https://prepmod.doh.wa.gov';
const BASE_URI = process.env.BASE_URL || '/clinic/search?page={page}';
const CLUSTER_THREADS = process.env.CLUSTER_THREADS || '1';
const MIN_AVAIL_NOTIF = process.env.MIN_AVAIL_NOTIF || '2';
const MIN_AVAIL = process.env.MIN_AVAIL || '1';
const PORT = process.env.PORT || '9000';
const REGION = process.env.REGION || 'WA';
const REFRESH = parseInt(process.env.REFRESH || '15', 10); //seconds
const USERAGENT = process.env.USERAGENT || 'Mozilla/5.0 (Macintosh; Intel Mac OS X 11_2_3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/89.0.4389.90 Safari/537.36';
